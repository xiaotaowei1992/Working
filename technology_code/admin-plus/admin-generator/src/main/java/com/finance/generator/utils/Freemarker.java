package com.finance.generator.utils;
...
import com.finance.common.utils.PathsUtils;
...
//			File file = new File(PathUtil.getClasspath() + filePath + outFile);
	...
	public static Template getTemplate(String ftlName, String ftlPath) throws Exception{
		try {
			...
			//设定去哪里读取相应的ftl模板文件
			cfg.setDirectoryForTemplateLoading(new File(PathsUtils.getClassResources()+ftlPath));
	...
	public static void main(String[] args) throws Exception {
		...
		String ftlName="list.ftl";
		String projectPath = System.getProperty("user.dir");
		Freemarker.printFile(ftlName,root,projectPath + "/admin-core/src/main/resources/templates/page/_list.html","templates/pageTemplates/");
	}
}
