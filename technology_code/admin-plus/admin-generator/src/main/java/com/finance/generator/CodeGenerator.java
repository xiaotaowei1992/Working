...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/fss_ys?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Hongkong");
...
//        strategy.setSuperEntityClass("com.finance.admin");
        strategy.setEntityLombokModel(true);
        strategy.setSuperControllerClass("com.finance.core.base.BaseController");
...
//        strategy.setSuperEntityColumns("id");
        ...
        //项目相对路径
        String projectRelative ="/admin-core/src/main/java/com/finance/core/"  +modelName;
